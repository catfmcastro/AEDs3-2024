...
public class CriarBytes {
    ...
    // Constante para manipulação de data a partir de 1900, pois o dado mais recente do BD é de 1999
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            raf = new RandomAccessFile("./transformar_byte/games_tobyte.csv", "r");
            write = new RandomAccessFile("./scr/db/games.db", "rw");
            ...
            while ((str = raf.readLine()) != null) {
                ...
                Games tmp = new Games(Integer.parseInt(vet[0]), Integer.parseInt(vet[1]), Float.parseFloat(vet[3]), vet[2], vet[4], vet[5], vet[6], trasnformDate(vet[7])); // Salva o valor em um game temporario
